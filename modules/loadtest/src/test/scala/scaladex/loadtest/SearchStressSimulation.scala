...
/** Isolated Elasticsearch stress: only the ES-backed endpoints (search, autocomplete, front page)
  * ramped to failure, to attribute saturation to the search engine specifically. Watch
  * `search_request_duration_seconds` in Grafana.
  */
