...
/** Mixed ramp-to-failure: one request per virtual user, weighted to mirror real UI traffic, injected
  * at a linearly increasing rate to find the knee (where latency/errors blow up) and the first
